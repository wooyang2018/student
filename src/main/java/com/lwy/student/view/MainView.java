...
public class MainView extends JFrame {
	...
	private JButton jButtonFirst, jButtonLast, jButtonNext, jButtonPre, jButtonAdd, jButtonDelete,
			jButtonUpdate,jButtonSystemUpdate,jButtonFind;
	...
	private void init() {
		...
		// SystemUpdate
		jButtonSystemUpdate = new JButton(AppConstants.SYSTEM_UPDATE);
		jButtonSystemUpdate.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(Upgrader.cmpversion())
					new SysUpdateView();
				else{
		...
		jPanelNorth.add(jButtonSystemUpdate);
		// add
